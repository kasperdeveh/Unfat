...
- Migrations: `20260504151548_favorites.sql` (tabellen + RLS) + `20260504153252_favorites_rls_conventions.sql` (snake_case policy-namen + `to authenticated` clause om aan te sluiten bij project-conventie). SW cache v32 → v33
